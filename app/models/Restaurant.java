...
public class Restaurant extends BaseModel<Restaurant> {
	...
	@Override
	 public void update(Restaurant data) {
	    ...
	    if (data.getVotes() != null) setVotes(data.getVotes());
	    if (data.getPriceRange() != null) setPriceRange(data.getPriceRange());
	    if (data.getImageFileName() != null) setImageFileName(data.getImageFileName());
	    if (data.getCoverFileName() != null) setCoverFileName(data.getCoverFileName());
